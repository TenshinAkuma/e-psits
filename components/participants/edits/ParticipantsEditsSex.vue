<template>
	<div class="fs-7">
		<div class="d-flex justify-content-between">
			<div class="text-secondary">Sex</div>
			<button
				type="button"
		...
		<p v-if="!isEditing" class="fw-bold lh-sm">
			{{ participant.sex || "No data available." }}
		</p>

		<form v-else @submit.prevent="OnSaveParticipantEdit" class="mt-1 mb-3">
			<select class="form-select border-secondary mb-3" v-model="participantEdit.sex">
