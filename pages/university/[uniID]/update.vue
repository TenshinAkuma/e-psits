        ...
        <div>
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb fs-5 mb-5">
                  <NuxtLink to="/university" class="breadcrumb-item text-decoration-none" style="color: #46468f;"> List of universities </NuxtLink>
                  <NuxtLink :to="`/university/${uniID}`" class="breadcrumb-item text-decoration-none" style="color: #46468f;"> University profile </NuxtLink>
            ...
            <div class="col-6 mb-3">
               <div class="row mb-5">
                  <div class="col-12 mb-3">
                     <label for="school-name" class="text-secondary">School name</label>
                     <input type="text" class="form-control" id="school-name" v-model="school_name">
                  </div>
                  <div class="col-12 mb-3">
                     <label for="school-address" class="text-secondary">School address</label>
                     <input type="text" class="form-control" id="school-address" v-model="school_address">
                  </div>
                  <div class="col-6 mb-3">
                     <label for="school-email" class="text-secondary">School email</label>
                     <input type="email" class="form-control" id="school-email" v-model="school_email">
                  </div>
                  <div class="col-6 mb-3">
                     <label for="school-phone-number" class="text-secondary">School phone number</label>
                     <input type="text" class="form-control" id="school-phone-number" v-model="school_phone_number">
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-12 mb-3">
                     ...
                     <input type="text" class="form-control" id="contact-name" v-model="contact_name">
                  </div>
                  <div class="col-6 mb-3">
                     <label for="contact-position" class="text-secondary">Position</label>
                     <input type="text" class="form-control" id="contact-position" v-model="contact_position">
                  </div>
                  <div class="col-6 mb-3">
                     <label for="contact-phone-number" class="text-secondary">Phone number</label>
                     <input type="text" class="form-control" id="contact-phone-number" v-model="contact_phone_number">
                  </div>
                  <div class="col-8 mb-3">
                     <label for="contact-email" class="text-secondary">Email</label>
                     <input type="email" class="form-control" id="contact-email" v-model="contact_email">
                  </div>
               </div>
            </div>
         </div>
